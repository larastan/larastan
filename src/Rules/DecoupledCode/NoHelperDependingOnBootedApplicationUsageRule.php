...
class NoHelperDependingOnBootedApplicationUsageRule implements Rule
{
    private const GLOBAL_HELPERS_ALTERNATIVES = [
        ...
        '__'            => 'Inject Illuminate\Translation\Translator and use method "translate"',
        'trans'         => 'Inject Illuminate\Translation\Translator and use method "translate"',
        'trans_choice'  => 'Inject Illuminate\Translation\Translator and use method "choice"',
        ...
        'config'        => 'Inject Illuminate\Config\Repository and use method "all" or "get"',
        'logger'        => 'Inject Illuminate\Log\LogManager and use method "debug" or the class itself when currently called without parameters',
        'info'          => 'Inject Illuminate\Log\LogManager and use method "info"',
        ...
        'encrypt'       => 'Inject Illuminate\Encryption\Encrypter and use method "encrypt"',
        'decrypt'       => 'Inject Illuminate\Encryption\Encrypter and use method "decrypt"',
        'bcrypt'        => 'Inject Illuminate\Hashing\HashManager and use "->driver(\'bcrypt\')->make()"',
        ...
        'broadcast'     => 'Inject Illuminate\Broadcasting\BroadcastManager and use method "event"',
        'dispatch'      => 'Inject Illuminate\Bus\Dispatcher and use method "dispatch"',
        'event'         => 'Inject Illuminate\Events\Dispatcher and use method "dispatch"',
        ...
        'validator'     => 'Inject Illuminate\Validation\Factory and use method "make"',
        'cache'         => 'Inject Illuminate\Cache\CacheManager and use method "get"',
