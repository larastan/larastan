...
class BuilderRelationsMethodParameterClosureTypeExtension implements MethodParameterClosureTypeExtension
{
    ...
    public function getTypeFromMethodCall(
        ...
        $modelType = $calledOnType->getTemplateType(Builder::class, LaravelVersion::getBuilderModelGenericName());
