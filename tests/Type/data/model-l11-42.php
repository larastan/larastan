...
class AbstractModel extends Model
{
    ...
    {
        assertType('static(ModelL1142\AbstractModel)', static::query()->create());
...
class Bar extends Model
{
    ...
    {
        assertType('Illuminate\Database\Eloquent\Builder<$this(ModelL1142\Bar)>', self::query());
        assertType('Illuminate\Database\Eloquent\Builder<static(ModelL1142\Bar)>', static::query());

        assertType('$this(ModelL1142\Bar)|null', self::query()->first());
        assertType('static(ModelL1142\Bar)|null', static::query()->first());
        assertType('Illuminate\Database\Eloquent\Builder<static(ModelL1142\Bar)>', static::query()->orWhere('foo', 'bar'));
        assertType('Illuminate\Database\Eloquent\Builder<static(ModelL1142\Bar)>', static::query()->select('foo'));
    }
}
...
function test(
    ...
    assertType('ModelL1142\Child', Child::new());

    assertType('App\User|null', User::find(1));
    assertType('ModelL1142\Bar|null', Bar::findByHashId('1'));
