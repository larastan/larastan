...
namespace EloquentBuilderL1142;
...
function test(
    ...
    assertType('Illuminate\Database\Eloquent\Builder<TModelClass of Illuminate\Database\Eloquent\Model (function EloquentBuilderL1142\test(), argument)>', $templateBuilder->select());
}
...
class TestModel extends Model
{
    ...
    {
        assertType('Illuminate\Database\Eloquent\Collection<int, EloquentBuilderL1142\TestModel>', $this->where('email', 1)->get());
        assertType('Illuminate\Database\Eloquent\Builder<static(EloquentBuilderL1142\TestModel)>', static::query()->where('email', 'bar'));
        assertType('Illuminate\Database\Eloquent\Builder<EloquentBuilderL1142\TestModel>', $this->where('email', 'bar'));
    }
}
...
abstract class UnionClass
{
    ...
    {
        assertType('TModel of App\Team|App\User (class EloquentBuilderL1142\UnionClass, argument)', $this->getQuery()->findOrFail($id));
