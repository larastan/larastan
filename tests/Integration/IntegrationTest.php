    ...
    public static function dataIntegrationTests(): iterable
    {
        ...
        if (version_compare(LARAVEL_VERSION, '11.0.0', '<')) {
            yield [
                ...
                [
                    4 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\Account>::where() expects array<int|model property of App\Account, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\Account>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\Account, \'foo\' given.'],
                    ...
                    10 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\Post>::where() expects array<int|model property of App\Post, mixed>|(Closure(App\PostBuilder<App\Post>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\Post, \'foo\' given.'],
                ],
            ];
        ...
        yield [
            ...
            [
                ...
                11 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\Post>::where() expects array<int|model property of App\Post, mixed>|(Closure(App\PostBuilder<App\Post>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\Post, \'foo\' given.'],
            ],
        ];
    }
