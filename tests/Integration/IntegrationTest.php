    ...
    public static function dataIntegrationTests(): iterable
    {
        ...
        yield 'eloquent-where' => [
            ...
            [
                ...
                53 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::orWhere() expects array<int|model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>|Illuminate\Database\Query\Builder): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, static-Closure(int): void given.'],
            ],
        ];
