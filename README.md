...
> Using Larastan for analysing Laravel packages? You may need to install `orchestra/testbench`. Simiarly, if you have phpstan and larastand installed separetely, together, using `bamarni/composer-bin-plugin`.
